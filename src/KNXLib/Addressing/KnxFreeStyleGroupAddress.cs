namespace KNXLib.Addressing
{
    ...
    public class KnxFreeStyleGroupAddress : KnxGroupAddress
    {
        ...
        public KnxFreeStyleGroupAddress(string groupAddress) => InternalParse(groupAddress);

        public KnxFreeStyleGroupAddress(byte[] groupAddress) => InternalParse(groupAddress);
        ...
        public override string ToString() => $"{SubGroup}";

        public override bool Equals(object obj) => obj is KnxFreeStyleGroupAddress && base.Equals(obj);
