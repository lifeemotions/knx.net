...
namespace KNXLib.Addressing
{
    public class KnxIndividualAddress : KnxAddress
    {
        ...
        public KnxIndividualAddress(string address)
        {
            InternalParse(address);
        }

        public KnxIndividualAddress(byte[] address)
        {
            InternalParse(address);
        }
        ...
        {
            return $"{Area}.{Line}.{Participant}";
        }

        public static new KnxIndividualAddress Parse(string address)
        {
            return new KnxIndividualAddress(address);
        }

        public static KnxIndividualAddress Parse(byte[] address)
        {
            return new KnxIndividualAddress(address);
        }
        ...
        {
            return (Area == area && Line == line && Participant == participant);
        }

        public override bool Equals(object obj)
        {
            if (obj is KnxIndividualAddress)
