namespace KNXLib
{
    ...
    public class KnxControlField1
    {
        ...
        internal KnxControlField1(byte value) => Parse(value);
        ...
        public byte GetValue()
        {
            ...
            switch (TelegramPriority)
            {
                case KnxTelegramPriority.Low:
                    result = (byte)(result | 0b0000_1100);
                    break;
                case KnxTelegramPriority.Normal:
                    result = (byte)(result | 0b0000_1100);
                    break;
                case KnxTelegramPriority.Urgent:
        ...
        public override string ToString() 
            => $"Type: {TelegramType.ToString()} // Repeated: {TelegramRepetitionStatus.ToString()} // Priority: {TelegramPriority.ToString()}";
    }
}
