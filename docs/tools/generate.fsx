...
let githubLink = "http://github.com/lifeemotions/knx.net"

// Specify more information about your project
let info =
  [ "project-name", "KNX.net"
    "project-author", "lifeemotions"
    "project-summary", "KNX.net provides a KNX API for .NET"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/KNX.net" ]
