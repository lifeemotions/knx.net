...
namespace KNXLib
{
    public class KNXConnectionTunneling : KNXConnection
    {
        ...
        internal void ConnectRequest()
        {
            ...
            dgram[14] = 0x08;
            dgram[15] = 0x01;
            dgram[16] = this.RemoteEndpoint.Address.GetAddressBytes()[0];
            dgram[17] = this.RemoteEndpoint.Address.GetAddressBytes()[1];
            dgram[18] = this.RemoteEndpoint.Address.GetAddressBytes()[2];
            dgram[19] = this.RemoteEndpoint.Address.GetAddressBytes()[3];
            dgram[20] = (byte)(this.RemoteEndpoint.Port >> 8);
            dgram[21] = (byte)(this.RemoteEndpoint.Port);
            dgram[22] = 0x04;
            dgram[23] = 0x04;
            dgram[24] = 0x02;
            dgram[25] = 0x00;
